...
import com.github.api.client.ProjectColumn;
...
import com.github.api.client.WebhookprojectcolumneditedChanges;
...
public class WebhookProjectColumnEdited {
  ...
  private WebhookprojectcolumneditedChanges changes = null;
  ...
  public WebhookProjectColumnEdited action(Object action) {
    this.action = action;
    return this;
  }
