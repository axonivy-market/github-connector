...
import com.github.api.client.WebhookrepositorytransferredChanges;
...
public class WebhookRepositoryTransferred {
  ...
  private WebhookrepositorytransferredChanges changes = null;
  ...
  public WebhookRepositoryTransferred action(Object action) {
    this.action = action;
    return this;
  }
