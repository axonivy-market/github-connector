...
import com.github.api.client.Issue2;
...
import com.github.api.client.WebhookissueseditedChanges;
...
public class WebhookIssuesEdited {
  ...
  private WebhookissueseditedChanges changes = null;
  ...
  public WebhookIssuesEdited action(Object action) {
    this.action = action;
    return this;
  }
