...
import com.github.api.client.Membership;
...
import com.github.api.client.WebhookorganizationrenamedChanges;
...
public class WebhookOrganizationRenamed {
  ...
  private WebhookorganizationrenamedChanges changes = null;
  ...
  public WebhookOrganizationRenamed action(Object action) {
    this.action = action;
    return this;
  }
