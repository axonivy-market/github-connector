...
import com.github.api.client.PullrequestHeadRepo;
...
public class PullrequestHead {
  ...
  @JsonProperty("repo")
  private PullrequestHeadRepo repo = null;

  @JsonProperty("sha")
  private Object sha = null;

  @JsonProperty("user")
  private PullrequestHeadRepoOwner user = null;

  public PullrequestHead label(Object label) {
    this.label = label;
    return this;
  }
  ...
  **/
  ...
  public PullrequestHead ref(Object ref) {
    this.ref = ref;
    return this;
  }
  ...
  **/
  ...
  public PullrequestHead sha(Object sha) {
    this.sha = sha;
    return this;
  }
  ...
  **/
  ...
  public PullrequestHead user(PullrequestHeadRepoOwner user) {
    this.user = user;
    return this;
  }
   ...
   * @return user
  **/
  public PullrequestHeadRepoOwner getUser() {
    return user;
  }

  public void setUser(PullrequestHeadRepoOwner user) {
    this.user = user;
  }
