...
import com.github.api.client.WebhookdiscussiontransferredChanges;
...
public class WebhookDiscussionTransferred {
  ...
  private WebhookdiscussiontransferredChanges changes = null;
  ...
  public WebhookDiscussionTransferred action(Object action) {
    this.action = action;
    return this;
  }
