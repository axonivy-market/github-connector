...
public class WebhookWorkflowRunRequested {
  ...
  private WorkflowRun workflowRun = null;

  public WebhookWorkflowRunRequested action(Object action) {
    this.action = action;
    return this;
  }
  ...
  **/
  ...
  public WebhookWorkflowRunRequested workflowRun(WorkflowRun workflowRun) {
