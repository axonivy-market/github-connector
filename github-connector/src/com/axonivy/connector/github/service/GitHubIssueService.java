...
public class GitHubIssueService extends AbstractGitHubService {
  ...
  public List<Issue> getAssignedIssues(int page, int pageSize) {
    ...
    return JSONConverter.convertToListDirect(result.get(GH_LIST_ISSUES_RESULT), Issue.class);
  }
  ...
  public IssueAdvanced searchIssuesByCriteria(SearchIssueCriteria criteria, int page, int pageSize) {
    if (criteria == null) {
      return null;
    }
    ...
    return result.get(GH_LIST_ISSUES_RESULT, IssueAdvanced.class);
  }

  public IssueAdvanced searchIssuesByKeyword(String keyword, int page, int pageSize) {
  ...
  public BigInteger countIssuesByCriteria(SearchIssueCriteria criteria) {
    ...
    IssueAdvanced result = searchIssuesByCriteria(criteria, 1, 10);
  ...
  public List<IssueComment> getIssueComments(String owner, String repo, BigInteger issueNumber) {
    ...
    var result =  createCallSubProcessWithStartPath(GH_GET_COMMENTS_START)
        ...
        .withParam("issueNumber", issueNumber)
        .call();
    List<IssueComment> issueComment = JSONConverter.convertToList(result.get("issueComments"), IssueComment.class);
    return issueComment;
  }
